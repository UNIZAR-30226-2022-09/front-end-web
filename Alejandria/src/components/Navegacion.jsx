...
function Navegacion() {
  ...
  return (
      ...
      <div className="px-5 items-center w-1/6 dark:text-white">
        ...
        <div className="grid divide-y ">
            <Link to="/myAccount">
              <button
                type="submit"
                className="px-2 py-2 flex gap-2 text-2xl bg-transparent cursor-pointer transition-al hover:bg-verdeClaro dark:hover:bg-doradoClaro rounded-xl hover:opacity-80"
              >
